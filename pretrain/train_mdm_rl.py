...
def setup(
    devices: int = 1,
    train_data_dir: Path = Path("/yinyongjing/SMDM/packed_data"),
    val_data_dir: Path = Path("/yinyongjing/SMDM/packed_data"),
    precision: Optional[str] = None,
    tpu: bool = False,
    resume: Union[bool, Path] = True,
) -> None:
    global out_dir
    hp_name = f'mdm-{args.model}M-{args.flops}-ssl-{args.ssl_ratio}'
